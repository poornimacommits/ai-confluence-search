...
def extract_filters(query: str):
    ...
    - Consider leap year and generate the dates accordingly, e.g. February 2026 is not a leap year and has 28 days only 
    ...
    - drop words like "pages", "Confluence", "documents" from "semantic_query"
